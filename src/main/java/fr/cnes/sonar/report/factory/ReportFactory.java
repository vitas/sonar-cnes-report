...
public class ReportFactory {
     ...
     */
    public ReportFactory(final String pUrl, final String pProject, final String pAuthor, final String pDate) {
        this.url = pUrl;
    ...
    public Report create() throws IOException, BadSonarQubeRequestException, UnknownQualityGateException {
        ...
        final IssuesProvider issuesProvider = new IssuesProvider(this.url, this.project);
        final MeasureProvider measureProvider = new MeasureProvider(this.url, this.project);
        final ProjectProvider projectProvider = new ProjectProvider(this.url, this.project);
        final QualityProfileProvider qualityProfileProvider = new QualityProfileProvider(this.url, this.project);
        final QualityGateProvider qualityGateProvider = new QualityGateProvider(this.url, this.project);
        final LanguageProvider languageProvider = new LanguageProvider(this.url, this.project);
