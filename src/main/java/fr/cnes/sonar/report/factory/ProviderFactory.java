...
public class ProviderFactory {
     ...
     * @param branch The branch name of the project to report.
     *
     */
    public ProviderFactory(final SonarQubeServer server, final String token, final String project, final String branch) {
        // get sonar server
        this.server = server;
        // get user token
        this.token = token;
     ...
     * - Constructor(final String server, final String token, final String project, final string branch)
     *
